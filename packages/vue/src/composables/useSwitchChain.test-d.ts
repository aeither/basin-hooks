...
import type { Connector, SwitchChainErrorType } from 'basin-hooks'
import type { Chain } from 'basin-hooks/chains'
import type { Compute, ExactPartial } from 'basin-hooks/internal'
