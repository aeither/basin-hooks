...
- It is highly recommended that you lock your `basin-hooks` and `typescript` versions to specific patch releases and upgrade with the expectation that types may be fixed or upgraded between any release.
