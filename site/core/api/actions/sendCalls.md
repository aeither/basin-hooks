...
```ts
import { sendCalls } from 'basin-hooks/experimental'
```
...
```ts
import { type SendCallsParameters } from 'basin-hooks/experimental'
```
...
```ts
import { type SendCallsReturnType } from 'basin-hooks/experimental'
```
...
```ts
import { type SendCallsErrorType } from 'basin-hooks/experimental'
```
