...
```ts
import { multicall } from 'basin-hooks'
```
...
```ts
import { type MulticallParameters } from 'basin-hooks'
```
...
```ts
import { type MulticallReturnType } from 'basin-hooks'
```
...
```ts
import { type MulticallErrorType } from 'basin-hooks'
```
