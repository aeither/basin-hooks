...
```ts
import { getEnsResolver } from 'basin-hooks'
```
...
```ts
import { type GetEnsResolverParameters } from 'basin-hooks'
```
...
```ts
import { type GetEnsResolverReturnType } from 'basin-hooks'
```
...
```ts
import { type getEnsResolverError } from 'basin-hooks'
```
