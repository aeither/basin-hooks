...
::: code-group
```ts [index.ts]
import { simulateContract, writeContract } from 'basin-hooks'
import { abi } from './abi'
import { config } from './config'
...
```ts
import { type WriteContractParameters } from 'basin-hooks'
```
...
::: code-group
```ts [index.ts]
import { getAccount, writeContract } from 'basin-hooks'
import { abi } from './abi'
import { config } from './config'
...
```ts
import { type WriteContractReturnType } from 'basin-hooks'
```
...
```ts
import { type WriteContractErrorType } from 'basin-hooks'
```
