...
```ts
import { getCallsStatus } from 'basin-hooks/experimental'
```
...
```ts
import { type GetCallsStatusParameters } from 'basin-hooks/experimental'
```
...
::: code-group
```ts [index.ts]
import { getConnections, getCallsStatus } from 'basin-hooks/experimental'
import { config } from './config'
...
```ts
import { type GetCallsStatusReturnType } from 'basin-hooks/experimental'
```
...
```ts
import { type GetCallsStatusErrorType } from 'basin-hooks/experimental'
```
