...
```ts
import { readContracts } from 'basin-hooks'
```
...
```ts
import { type ReadContractsParameters } from 'basin-hooks'
```
...
```ts
import { type ReadContractsReturnType } from 'basin-hooks'
```
...
```ts
import { type ReadContractsErrorType } from 'basin-hooks'
```
