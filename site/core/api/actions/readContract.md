...
```ts
import { type ReadContractParameters } from 'basin-hooks'
```
...
```ts
import { type ReadContractReturnType } from 'basin-hooks'
```
...
```ts
import { type ReadContractErrorType } from 'basin-hooks'
```
