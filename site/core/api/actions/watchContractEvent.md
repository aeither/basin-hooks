...
```ts
import { type WatchContractEventParameters } from 'basin-hooks'
```
...
```ts
import { type WatchContractEventReturnType } from 'basin-hooks'
```
...
```ts
import { type WatchContractEventError } from 'basin-hooks'
```
