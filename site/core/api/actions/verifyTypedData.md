...
```ts
import { verifyTypedData } from 'basin-hooks'
```
...
```ts
import { type VerifyTypedDataParameters } from 'basin-hooks'
```
...
```ts
import { type VerifyTypedDataReturnType } from 'basin-hooks'
```
...
```ts
import { type VerifyTypedDataErrorType } from 'basin-hooks'
```
