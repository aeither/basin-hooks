...
- Hooks are constructed by TanStack Query options helpers, exported by the `'basin-hooks/query'` entrypoint, and some additional code to wire up type parameters, hook into React Context, etc.
